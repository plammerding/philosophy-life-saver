...
export default function ErinnerungKarte({ erinnerung, onLoeschen }: Props) {
  ...
  return (
    <div className={clsx('ampel-card rounded-2xl border p-4', f.border, f.bg)}>
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex flex-wrap gap-2 mt-2">
            ...
            <span className="text-xs text-slate-400">
              {formatDatum(erinnerung.naechstesFaelligkeit)}
            </span>
          </div>
          ...
          <div className="flex gap-2 mt-2">
            ...
            <span className="text-xs text-slate-300">·</span>
            <span className="text-xs text-slate-400">
              Erinnerung {erinnerung.erinnerungTagsVorher}d vorher
            </span>
          </div>
